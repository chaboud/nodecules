...
| `table_chat.py` | a chat whose replies are presented on a **table**: decisions become presentations chosen for the surface, the person answers through an input strip, the business graph advances once per decision | not yet — needs the decision kind and a text presenter |
